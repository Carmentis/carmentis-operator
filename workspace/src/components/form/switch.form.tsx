...
export default function SwitchForm(input: {property: string, value: boolean, onChange: (value: boolean) => void}) {
	...
	return <label className="inline-flex items-center cursor-pointer">
		...
		<span className="ms-3 text-sm font-medium text-gray-900 dark:text-gray-300">{input.property}</span>
	</label>;
}
